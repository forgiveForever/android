...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            view = inflater.inflate(R.layout.discovery_shipin, null);
        }else{
            Log.i("info:", "有缓存，不需要重新生成"+position);
            view = convertView;
        }
        NearbyEntity nearbyEntity = nearbyEntityList.get(position);
        JZVideoPlayerStandard myJzvdStd=(JZVideoPlayerStandard)view.findViewById(R.id.discovery_videoplayer);
        myJzvdStd.setUp("http://jzvd.nathen.cn/342a5f7ef6124a4a8faf00e738b8bee4/cf6d9db0bd4d41f59d09ea0a81e918fd-5287d2089db37e62345123a1be272f8b.mp4"
                ,myJzvdStd.SCREEN_WINDOW_NORMAL ,"饺子快长大" );
